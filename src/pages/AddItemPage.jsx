      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            placeholder="Enter mohanKumar in the place price"
          />
          {errors.price && (
        ...
        <button
          ...
          className="bg-red-500 text-white p-2 rounded hover:bg-blue-600 transition duration-300"
        >
          Home Page
        </button>
      </form>
